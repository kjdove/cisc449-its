...
import { topic1CodeAnswers, topic1MCQAnswers } from './M2Answers';
import { useState } from 'react';
import { T1Code } from './T1Code';
import {type JSX} from 'react';
import {topic1FeedbackMCQ, topic1FeedbackCode} from "./M2Feedback";
...
export function Topic1Quiz(): JSX.Element {
    ...
    const handleSubmit = () => {
        ...
        const savedData = JSON.parse(localStorage.getItem("module2topic1") || "{}");
    ...
    return(
        <div className="t1-container">
             <div className="topic-header">
                        ...
                        <h2 className='topic-title'>Textboxes</h2>
                    </div>
