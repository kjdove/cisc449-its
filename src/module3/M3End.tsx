//Module 3 End of Module Quiz page
import type { JSX } from "react";
import type { EndQuiz, TopicData } from "../Types";
import {endOfModule} from "./M3Questions";
import { useState } from "react";
import { useNavigate } from "react-router-dom";

export function M3EndQuiz(): JSX.Element {
    ...
    const masteries: Record<string, number> = {
        tbVar: topicMasteryScore(t1Data, t1Questions),
        cbVar: topicMasteryScore(t2Data, t2Questions),
        ddVar: topicMasteryScore(t3Data, t3Questions),
    }
