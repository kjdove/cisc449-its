...
export const pretestQuestions = [
 //1.1
   ...
   {difficulty: "hard", id: "1.1h", question: "Fill in the blanks to create a basic form.", topicId: "1.1", correctAnswers: ["Group", "Label", "Label", "Control", "Text", "Text", "Group"]},
 ...
 //1.2
   ...
   {difficulty: "hard", id: "1.2h", question: "Fill in the blanks to create a form control with a placeholder and disabled state.", topicId: "1.2", correctAnswers: ["placeholder", "disabled"]},
 ...
 //1.3
   ...
   {difficulty: "hard", id: "1.3h", question: "Fill in the blanks to create a controlled form input that updates the state variable 'username' on change.", topicId: "1.3", correctAnswers: ["e.target.value"]},
 ...
 //2.1
   ...
   {difficulty: "hard", id: "2.1h", question: "Fill in the blanks to create a controlled textbox that updates the state variable 'email' on change.", topicId: "2.1", correctAnswers: ["Control", "text", "email", "e.target.value"]},
 ...
 //2.2
   ...
   {difficulty: "hard", id: "2.2h", question: "Fill in the blanks to create a controlled checkbox that updates the boolean state variable 'subscribe' on change.", topicId: "2.2", correctAnswers: ["Check", "checkbox", "subscribe", "e.target.checked"]},
 ...
 //2.3
   ...
   {difficulty: "hard", id: "2.3h", question: "Fill in the blanks to create a controlled dropdown that updates the state variable 'country' on change.", topicId: "2.3", correctAnswers: ["Select", "country", "e.target.value", "option", "option", "option", "option", "option", "option", "Select"]},
 ...
 //2.4
   ...
   {difficulty: "hard", id: "2.4h", question: "Fill in the blanks to create a form that includes a textbox for name input, a checkbox for newsletter subscription, and a dropdown for country selection.", topicId: "2.4", correctAnswers: ["text", "Select", "Select", "checkbox"]},
 ...
 //3.1
   ...
   {difficulty: "hard", id: "3.1h", question: "Fill in the blanks to create a form with an input number box for age and a textarea for comments.", topicId: "3.1", correctAnswers: ["number", "textarea"]},
 ...
 //3.2
   ...
   {difficulty: "hard", id: "3.2h", question: "Fill in the blanks to create a form with a switch for newsletter subscription and radio buttons for contact method selection.", topicId: "3.2", correctAnswers: ["switch", "radio", "radio", "radio"]},
...
//3.3
   ...
   {difficulty: "hard", id: "3.3h", question: "Fill in the blanks to create a dropdown that generates options from an array of country names using the .map() function.", topicId: "3.3", correctAnswers: ["map", "key"]},
